...
(* OASIS_START *)
(* DO NOT EDIT (digest: 8ae50e92c102f30351d5fae977084c8b) *)
(*
...
let setup_t =
  {
            ...
            OCamlbuildDocPlugin.doc_build
              {
                 OCamlbuildDocPlugin.extra_args =
                   [
                      "-use-ocamlfind";
                      "-docflags '-t Tree_layout -colorize-code -short-functors -charset utf-8'"
                   ];
                 run_path = "."
              })
       ];
            ...
            [
               Flag
                 ({
                   ...
                   {
                      flag_description = Some "Run benchmarks";
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules =
                        ["Tree_layout"; "Tree_layered"; "Tree_base"];
                      lib_pack = false;
                      lib_internal_modules = ["Tree_utils"];
               ...
               Doc
                 ({
                  ...
                  },
                   {
                      ...
                      doc_title = "API reference for Tree_layout";
                      doc_authors = [];
                      doc_abstract = None;
                      doc_format = OtherDoc;
                      doc_data_files = [];
               ...
               Library
                 ({
                   ...
                   },
                   {
                      ...
                      lib_findlib_parent = Some "tree_layout";
                      lib_findlib_name = None;
                      lib_findlib_containers = []
                   });
               Executable
                 ({
                     cs_name = "layered_test";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                      ...
                      bs_path = "tests";
                      bs_compiled_object = Best;
                      bs_build_depends = [InternalLibrary "rose"];
                      bs_build_tools = [ExternalTool "ocamlbuild"];
                      bs_c_sources = [];
                      bs_data_files = [];
                      bs_ccopt = [(OASISExpr.EBool true, [])];
                   ...
                   {exec_custom = false; exec_main_is = "layered_test.ml"});
               Test
                 ({
                     cs_name = "layered_test";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      ...
                      test_tools =
                        [
                           ...
                           InternalExecutable "layered_test"
                        ]
                   });
               Executable
                 ({
                     cs_name = "tree_benchmark";
                     cs_data = PropList.Data.create ();
                     cs_plugin_data = []
                  },
                   {
                   ...
                   {exec_custom = false; exec_main_is = "tree_bench.ml"});
               SrcRepo
                 ({
                     cs_name = "head";
                     cs_data = PropList.Data.create ();
                  ...
                  },
                   {
                      src_repo_type = Git;
                      src_repo_location =
                        "https://github.com/Drup/tree_layout.git";
                      src_repo_browser =
                        Some "https://github.com/Drup/tree_layout";
     ...
     oasis_version = "0.4.6";
     oasis_digest = Some "\001\150\244\169\214\006\rQ)\027T\127 \1536\020";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
