...
(* OASIS_START *)
(* DO NOT EDIT (digest: 87ef1f81b8a8f789ed94edb5ff7e5419) *)
(*
...
let setup_t =
  {
            ...
            CustomPlugin.Test.main
              {
                 CustomPlugin.cmd_main =
                   [(OASISExpr.EBool true, ("$tree_test", ["\"tree.svg\""]))];
            ...
            [
               ...
               Library
                 ({
                   ...
                   {
                      lib_modules = ["Tree_layout"];
                      lib_pack = false;
                      lib_internal_modules = ["Tree_layout_utils"];
     ...
     oasis_version = "0.4.5";
     oasis_digest = Some "a\221]3\168\224(\167\227$\005X\198\190\210\168";
     oasis_exec = None;
     oasis_setup_args = [];
     setup_update = false
  };;
